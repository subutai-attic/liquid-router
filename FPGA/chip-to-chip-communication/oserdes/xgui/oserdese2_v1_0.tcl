...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "data_rate_oq" -parent ${Page_0}
  ipgui::add_param $IPINST -name "data_rate_tq" -parent ${Page_0}
  ipgui::add_param $IPINST -name "serdes_mode" -parent ${Page_0}
  ipgui::add_param $IPINST -name "tristate_width" -parent ${Page_0}
